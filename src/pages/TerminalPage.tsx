...
export function TerminalPage({ section = 'Dashboard' }: { section?: string }) {
  ...
  return (
    <div className="min-h-screen bg-terminal-bg-primary font-[Inter] text-terminal-text-primary antialiased">
      <div className="flex">
